...
import { SidebarComponent } from "./layouts/vertical/sidebar/sidebar.component";
import { HeaderComponent } from "./layouts/vertical/header/header.component";
...
@Component({
    ...
    standalone   : true,
    imports      : [NgIf, EmptyLayoutComponent, CenteredLayoutComponent, EnterpriseLayoutComponent, MaterialLayoutComponent, ModernLayoutComponent, ClassicLayoutComponent, ClassyLayoutComponent, CompactLayoutComponent, DenseLayoutComponent, FuturisticLayoutComponent, ThinLayoutComponent, SettingsComponent,SidebarComponent,HeaderComponent],
})
